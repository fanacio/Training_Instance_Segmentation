...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        default='weights/yolact_base_249_1000.pth', type=str,
                        help='Trained state_dict file path to open. If "interrupt", this will open the interrupt file.')
    #top_k原始是5，现在改成15
    ...
    #这里默认default=None,现在为了调试方便改成我自己的路径.
    parser.add_argument('--images', default='fanyichao_test/images:fanyichao_test/images_out/', type=str,
